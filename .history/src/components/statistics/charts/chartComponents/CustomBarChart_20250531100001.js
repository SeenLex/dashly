...
function CustomTooltip({
  ...
  // Pentru suport extra (dacă le vrei):
  const slaStatusByCategory = []; // sau extrage-l ca prop
  const teamsByCategory = {}; // sau extrage-l ca prop
  const isPercent = false; // sau extrage-l ca prop
