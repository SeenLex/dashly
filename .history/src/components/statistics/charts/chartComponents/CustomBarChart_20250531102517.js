...
function CustomTooltip({
  ...
  console.log("Teams in category:", teamsByCategory[label]);
  console.log("SLA Status for category:", slaStatusByCategory.find((item) => item.name === label));
  ...
  zIndex: 9999,
  position: "relative",
  color: "#000", // forțează culoarea textului să fie negru
