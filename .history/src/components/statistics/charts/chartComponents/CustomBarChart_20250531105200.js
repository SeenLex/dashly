...
function CustomTooltip({ active, payload }) {
  ...
  return (
    <div
      ...
      onWheel={handleWheel} // aici oprește scroll-ul să urce la pagină
    >
      <div
        style={{
      ...
      <div
        style={{
          ...
          scrollbarWidth: "thin",
          paddingRight: "4px",
          maxHeight: "calc(400px - 60px)", // ca să nu depășească înălțimea totală cu header-ul
        }}
      >
        <ul
          style={{
