...
function CustomBarChart({
  ...
  stacked = false,
  colors = [],
  showBothValues = false, // Adăugăm un nou prop pentru a controla afișarea dublă
  totalCount, // Adăugăm totalCount pentru calculul procentelor
  ...props
}) {
              ...
              >
                {showBothValues && (
                  <LabelList
                    ...
                    position="top"
                    formatter={(value) => {
                      const total = data.find(item => item[categoryKey] === payload[categoryKey])?.count;
              ...
              {showBothValues && (
                <LabelList
                  ...
                  formatter={(value, entry) => {
                    // Calculăm procentul bazat pe totalCount sau pe totalul categoriei
