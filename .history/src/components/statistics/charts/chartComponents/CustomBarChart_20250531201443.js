...
TypeError: Cannot read properties of undefined (reading 'tickets')
    at getTeamProjects (http://localhost:3000/static/js/bundle.js:108331:36)
    at formatter (http://localhost:3000/static/js/bundle.js:108427:32)
    at getLabel (http://localhost:3000/static/js/bundle.js:89637:12)
    at Label (http://localhost:3000/static/js/bundle.js:89930:13)
    at react-stack-bottom-frame (http://localhost:3000/static/js/bundle.js:36785:18)
    at renderWithHooks (http://localhost:3000/static/js/bundle.js:26995:20)
    at updateFunctionComponent (http://localhost:3000/static/js/bundle.js:28688:17)
    at beginWork (http://localhost:3000/static/js/bundle.js:29274:16)
    at runWithFiberInDEV (http://localhost:3000/static/js/bundle.js:24767:68)
    at performUnitOfWork (http://localhost:3000/static/js/bundle.js:31347:93)
