...
<div style={/* your styles */}>
        ...
        <div style={{ 
          ...
          <p style={{ margin: 0, color: "#FF9800" }}>
            <strong>In Progress:</strong> {data["In Progress"] || 0}
          </p>
          <p style={{ margin: 0, color: "#F44336" }}>
            <strong>Exceeded:</strong> {data.Exceeded || 0}
          </p>
          <p style={{ margin: 0, color: "#666" }}>
            <strong>Total:</strong> {(data.Met || 0) + (data["In Progress"] || 0) + (data.Exceeded || 0)}
          </p>
        </div>
      </div>
    ...
    <div>
      ...
      <ResponsiveContainer width="100%" height={300}>
        ...
        >
          ...
          {Array.isArray(dataKey) ? (
            // Stacked bars for SLA compliance charts
            ...
            // Single bar for count/percentage charts
