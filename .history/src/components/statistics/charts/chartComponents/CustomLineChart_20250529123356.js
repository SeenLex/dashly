...
const CustomLineChart = ({
  ...
  <AreaChart
    data={data}
    layout="vertical"  // <=== asta inversează axele!
    margin={{
      top: 5,
      right: 30,
      left: 20,
  ...
  >
    ...
    <YAxis 
      type="category"        // Vertical axis becomes categorical (labels)
      dataKey="label"        // Date labels go here on vertical axis
    ...
    />
    <XAxis 
      type="number"          // Horizontal axis becomes numeric (counts)
      stroke="var(--text-color-secondary)"
