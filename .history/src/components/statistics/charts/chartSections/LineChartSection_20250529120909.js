...
useEffect(() => {
  const fetchTrendData = async () => {
    ...
    const daily = await fetch(`http://localhost/api/tickets?mode=trend&period=day&${baseParams}`).then(res => res.json());
    const weekly = await fetch(`http://localhost/api/tickets?mode=trend&period=week&${baseParams}`).then(res => res.json());
    const monthly = await fetch(`http://localhost/api/tickets?mode=trend&period=month&${baseParams}`).then(res => res.json());
