...
function PieChartSection({ tickets }) {
  ...
  // Tooltip customizat pentru PieChart
  const CustomTooltip = ({ active, payload, dataKey, nameKey }) => {
      ...
      <CustomHorizontalContainer
        components={[
          ...
          <CustomPieChart
            ...
            dataKey="count"
            nameKey="priority"
            tooltip={<CustomTooltip dataKey="count" nameKey="priority" />}
          ...
          <CustomPieChart
            ...
            dataKey="count"
            nameKey="team"
            tooltip={<CustomTooltip dataKey="count" nameKey="team" />}
          ...
          <CustomPieChart
            ...
            dataKey="value"
            nameKey="status"
            tooltip={<CustomTooltip dataKey="value" nameKey="status" />}
