...
//       const start_date = ticket.start_date;
...
//     const ticketDate = new Date(ticket.start_date.slice(0, -4));
//     let timeKey;
...
//     const created = new Date(ticket.start_date);
//     const closed = new Date(ticket.closed_date);
