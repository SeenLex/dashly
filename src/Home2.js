          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="hidden sm:block">
                <div className={`relative overflow-hidden px-4 py-2 rounded-full text-xs font-bold shadow-lg border ${
                  role === 'super_admin'
                  ...
                  <div className="relative z-10 flex items-center space-x-1.5">
                    ...
                    <span>{role === 'super_admin' ? 'SUPER ADMIN' : role === 'admin' ? 'ADMIN' : 'USER'}</span>
                  </div>
